Результат выполнения тестового задания <br> (само задание см. ниже)
=====================================
...
Настроено тестирование в пайплайнах
--------------
[Github Actions](https://github.com/iTearo/aspirant-test-issue/actions)
